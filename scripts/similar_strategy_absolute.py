...
if __name__ == "__main__":
    ...
    strategy_deaths.to_csv('../data/similar_strategy_absolute_deaths.csv')
    strategy_cases.to_csv('../data/similar_strategy_absolute_cases.csv')
    ...
    tests.to_csv('../data/similar_strategy_absolute_tests.csv')
    ...
    for name, df, y_title in zip(
            ['Cases', 'Deaths', 'Tests'],
            [strategy_cases, strategy_deaths, tests],
    ...
    fig.write_html("../figures_html/similar_strategy_absolute.html")
